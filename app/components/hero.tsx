...
export default function Hero() {
  ...
  return (
    <section className="relative bg-[#0f2d5e] h-screen flex items-center overflow-hidden">
      ...
      />
      {/* Animated glow orbs */}
      <div className="hero-orb-1 absolute top-1/4 -left-20 w-[500px] h-[500px] rounded-full bg-[#2563eb] opacity-[0.12] blur-[80px] pointer-events-none" />
      <div className="hero-orb-2 absolute bottom-0 right-1/4 w-[400px] h-[400px] rounded-full bg-[#1d4ed8] opacity-[0.10] blur-[80px] pointer-events-none" />
      <div className="hero-orb-3 absolute top-1/2 right-0 w-[300px] h-[300px] rounded-full bg-[#3b82f6] opacity-[0.08] blur-[60px] pointer-events-none" />
