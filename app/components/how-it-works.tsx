...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-20 lg:py-28 bg-[#fff7ed]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          <div className="hidden lg:block absolute top-12 left-1/2 -translate-x-1/2 w-2/3 h-px bg-gradient-to-r from-transparent via-[#f97316]/30 to-transparent" />

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {steps.map((step, index) => (
              <div key={step.number} className="relative flex flex-col items-center text-center">
                <div className="relative z-10 w-24 h-24 rounded-2xl bg-white shadow-lg shadow-blue-500/10 border border-[#fed7aa] flex flex-col items-center justify-center mb-6">
                  <span className="text-3xl font-black text-[#f97316]">{step.number}</span>
                </div>

                {index < steps.length - 1 && (
                  <div className="lg:hidden absolute top-12 left-1/2 translate-x-8 h-full w-px bg-gradient-to-b from-[#f97316]/30 to-transparent" />
                )}
                ...
                <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#f97316] bg-white px-3 py-1.5 rounded-full border border-[#fed7aa]">
