...
export default function SuccessPage() {
  return (
    <main className="min-h-screen bg-[#171717] flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-white/60 text-lg leading-relaxed mb-8">
          You&apos;re all set. A Shopify expert will reach out to you within the hour. Check your inbox for confirmation.
        </p>

        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8 text-left space-y-3">
          <div className="flex items-center gap-3">
            <svg className="w-4 h-4 text-[#fb923c] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
            </svg>
            <span className="text-white/80 text-sm">Expert assigned to your case</span>
          </div>
          <div className="flex items-center gap-3">
            <svg className="w-4 h-4 text-[#fb923c] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
            </svg>
            <span className="text-white/80 text-sm">Confirmation email sent to you</span>
          </div>
          <div className="flex items-center gap-3">
            <svg className="w-4 h-4 text-[#fb923c] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M5 13l4 4L19 7" />
            </svg>
            <span className="text-white/80 text-sm">Fix report delivered after completion</span>
          </div>
        </div>
